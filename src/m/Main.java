...
public class Main extends SimpleApplication
{
	...
	public void simpleInitApp()
	{
		...
		Pather pather = new Pather(new Identifier("Mage_10"), new HexLocation(2, 1, 3, 0),
				new HexDirection(6), AirState.UP, new TX_AP_Transform(new Equipable(new Agro(), new Agro(), null, null, null), 0));
		...
		Pather pather2 = new Pather(new Identifier("Equip_12"), new HexLocation(2, 3, 0, 0),
				new HexDirection(5), AirState.FLOOR, new TX_AP_Transform(new Equipable(new Agro(), null, null, null, null), 1));
